...
const williamLucas = {
    ...
    renderHeader: (r, set) => (
        <div className="text-center">
            <Field value={r.name} onChange={(v) => set('name', v)} ph="YOUR NAME" className="block text-[2.6em] font-medium leading-tight [font-variant:small-caps]" />
            <Field value={r.location} onChange={(v) => set('location', v)} ph="Location" className="mt-1 block text-[1.05em]" />
    ...
    renderTitle: (title) => (
        <>
            <h2 className="text-[1.15em] tracking-wide [font-variant:small-caps]">{title}</h2>
