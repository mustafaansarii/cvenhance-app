...
const michaelRodriguez = {
    code: 'michael-rodriguez',
    ...
    renderHeader: (r, set) => (
        <div className="flex items-end justify-between gap-6">
            <div className="min-w-0">
                ...
                <Field value={r.location} onChange={(v) => set('location', v)} ph="Location" className="mt-1 block text-[1.05em] italic text-slate-700" />
            </div>
            <div className="flex shrink-0 flex-col items-end gap-y-1 text-right text-[0.85em]">
    ...
    renderTitle: (title) => (
        <>
            <h2 className="text-[1.2em] font-bold text-[color:var(--rb-accent)]">{title}</h2>
                ...
                <>
                    <div className="flex items-baseline justify-between gap-4">
                        ...
                        <span className="flex shrink-0 items-baseline gap-1.5 whitespace-nowrap">
                            <Field value={item.githubUrl} onChange={(v) => update({ githubUrl: v })} ph="GitHub URL" className="text-blue-700 underline" />
                            <span className="text-slate-400">|</span>
                            <Field value={item.liveUrl} onChange={(v) => update({ liveUrl: v })} ph="Live URL" className="text-blue-700 underline" />
                        </span>
                    </div>
                    <Bullets bullets={bullets} />
                </>
...
export default michaelRodriguez;
